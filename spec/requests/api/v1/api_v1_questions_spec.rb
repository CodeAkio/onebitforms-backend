    ...
    context 'With valid authentication headers' do
      ...
      context 'And with valid params' do
        before do
          ...
          post '/api/v1/questions', params: { question: @question_attributes, form_id: @form.id },
  ...
  describe 'PUT /questions/:id' do
    ...
    context 'With valid authentication headers' do
      ...
      context 'When question exists' do
        context 'And user is the questions owner' do
          before do
            ...
            @question_attributes = attributes_for(:question)
            put "/api/v1/questions/#{@question.id}", params: { question: @question_attributes },
                                                     headers: header_with_authentication(@user)
          end
      ...
      context 'When question dont exists' do
        ...
        it 'returns 404' do
          delete '/api/v1/questions/0', params: { question: @question_attributes },
                                        headers: header_with_authentication(@user)
          expect_status(404)
        end
      end
