  ...
  describe 'POST /answers' do
    context 'And with valid form id' do
      before do
        ...
        post '/api/v1/answers',
             params: { form_id: @form.id, questions_answers: [@questions_answers_1_attributes, @questions_answers_2_attributes] }, headers: header_with_authentication(@user)
      end
    ...
    context 'And with invalid form id' do
      before do
        ...
        post '/api/v1/answers', params: { form_id: 0 }, headers: header_with_authentication(@other_user)
      end
